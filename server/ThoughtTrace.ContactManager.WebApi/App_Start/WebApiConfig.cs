    ...
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            builder.Register(context => SeedData())
                .SingleInstance();
            builder.Register(context => SeedDataGroup()).SingleInstance();
        ...
        private static ConcurrentDictionary<Guid, Group> SeedDataGroup()
        {
            var store = new ConcurrentDictionary<Guid, Group>();
            AddGroup(store, "HR", "HR Department", null);
            AddGroup(store, "IT", "IT Department", null);
            AddGroup(store, "Manager", "Manager Department", null);
        ...
        {
            var guid = Guid.NewGuid();
            store.TryAdd(guid, new Group { Name = name, Description = description, Id = guid });
        }
    }
}
